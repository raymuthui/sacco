	...
	<div class="col-lg-12">
		<form id="manage-payment">
			...
			<div class="form-group">
				...
				<select name="loan_id" id="" class="form-control custom-select browser-default select2">
					<option value=""></option>
					<?php
			...
			<div class="form-group">
				...
				<select name="payment_method" id="" class="form-control custom-select browser-default select2">
					<option value=""></option>
			...
			<div>
				<label class="control-label" for="penalty_amount">Penalty Amount</label>
				<input class="form-control" type="number" name="penalty_amount" id="penalty_amount">
			</div>
			<div class="form-group">
