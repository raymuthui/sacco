        ...
        <div class="card-body">
          ...
          <form id="registration-form">
            <div class="form-group row">
              <div class="col">
                <label for="lastname" class="control-label">Name of Institution</label>
                <input type="text" id="institution_name" name="institution_name" class="form-control">
              </div>
              <div class="col">
                <label for="firstname" class="control-label">Representative Name</label>
                <input type="text" id="rep_name" name="rep_name" class="form-control">
              </div>
              <div class="col">
                <label for="middlename" class="control-label">License Number</label>
            ...
            <div class="form-group row">
              <div class="col">
                <label for="id_front" class="control-label">Representative's ID Front Picture</label>
                <input type="file" id="id_front" name="id_front" class="form-control">
              </div>
              <div class="col">
                <label for="id_back" class="control-label">Representative's ID  Back Picture</label>
...
<script>
  ...
  $('#registration-form').submit(function(e) {
    ...
    $.ajax({
      url: 'ajax.php?action=save_member2',
      method: 'POST',
      data: formData,
      contentType: false,
      processData: false,
